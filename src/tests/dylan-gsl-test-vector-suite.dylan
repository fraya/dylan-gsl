...
define test test-addition ()
  ...
  expect-true(v=(v1 + v2, v3),
	       "Addition of vectors");
  expect-true(v=(v1 + v2, v2 + v1),
	       "Addition is commutative");
  expect-true(v=((v1 + v2) + v3, v1 + (v2 + v3)),
	       "Addition is associative");
  expect-true(v=(z0 + v1, v1),
...
define test test-scalar ()
  ...
  expect-true(v=(v1 * 3.0d0, v2),
	       "Scalar multiplication");
  expect-true(v=(v1 * 1.0d0, v1),
	       "1 is a multiplicative identity");
  expect-true(v=((a * b) * v1, a * (b * v1)),
	       "Scalar multiplication is associative");
  expect-true(v=(a * (v1 + v2), a * v1 + a * v2),
	       "Scalar multiplication distributes over vector addition");
  expect-true(v=((a + b) * v1, a * v1 + b * v1),
